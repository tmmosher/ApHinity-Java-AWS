...
public class ApiExceptionHandler {
    ...
    private static final Map<String, ErrorDefinition> SAFE_REASONS = Map.<String, ErrorDefinition>ofEntries(
        ...
        Map.entry("Must be at least 12 characters", new ErrorDefinition("password_too_short", "Must be at least 12 characters")),
        ...
        Map.entry("Password must be at least 12 characters long", new ErrorDefinition("password_too_short", "Password must be at least 12 characters long")),

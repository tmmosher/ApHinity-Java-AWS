...
class LocationGraphPipelineWebMvcTest {
    ...
    @Test
    void updateLocationGraphDataPreservesVerticalBarOrientationThroughPipeline() throws Exception {
        Long userId = 42L;
        Long locationId = 78L;
                          ...
                          "graphs": [
                            {
                              "graphId": 310,
                              "data": [
                                {"type": "bar", "orientation": "v", "x": ["Jan", "Feb"], "y": [9, 8]}
                              ]
                            }
                          ]
                        }
    ...
    void createLocationGraphBuildsDefaultPayloadAndAppendsItToRequestedSection() throws Exception {
        ...
        mockMvc.perform(
            ...
            .andExpect(jsonPath("$.layout.xaxis.title").value("Value"))
            .andExpect(jsonPath("$.layout.yaxis.automargin").value(true))

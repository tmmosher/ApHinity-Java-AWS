...
import {advanceGraphLoadAnimationToken} from "../pages/authenticated/panels/location/DashboardLocationDashboardPanel";

describe("DashboardLocationDashboardPanel graph animation token", () => {

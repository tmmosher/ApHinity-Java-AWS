...
vi.mock("../components/graph/TabulatorGraph", () => ({
  __esModule: true,
  default: (props: Record<string, unknown>) => {
    capturedTabulatorProps.push(props);
    return null;
  }
}));
...
describe("LocationDashboardSection", () => {
  ...
  it("renders metadata-tagged table graphs with Tabulator instead of Plotly", () => {
    capturedChartProps.length = 0;
    capturedTabulatorProps.length = 0;
    const section: LocationSectionLayout = {
      section_id: 7,
      graph_ids: [101]
    };

...
const baseNavItemClass = "flex min-h-11 w-full items-center rounded-[inherit] px-3 py-2.5 text-sm font-medium transition-[background-color,color,box-shadow] duration-200 focus:outline-none";
const inactiveNavItemClass = "text-base-content/72 hover:bg-base-200/70 hover:text-base-content";
const activeNavItemClass = "bg-base-200/85 text-base-content shadow-sm";

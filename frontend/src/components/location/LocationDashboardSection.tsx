...
export const LocationDashboardSection = (props: LocationDashboardSectionProps) => (
  <section class="min-w-[min(100%,42rem)] max-w-1/2 flex-1 rounded-xl border border-base-300 bg-base-100 p-5 shadow-sm" data-section-id={props.section.section_id}>
    <Show
